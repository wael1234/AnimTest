...
import com.example.animtest.DancingInterpolator;
...
public class DancingView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public static final int DEFAULT_POINT_COLOR = Color.parseColor("#ffffff");
    public static final int DEFAULT_BALL_COLOR = Color.parseColor("#ffffff");
    ...
    public static final float MAX_OFFSET_Y = 50;//水平下降最大偏移距离
...
//                invalidate();
        ...
        mFreeDownController.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                Log.i("111111","t:"+t);
//                Log.i("111111","freeBallDistance:"+freeBallDistance+"");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (state == STATE_DOWN) {//下落
            ...
            if (!isBounced) {
               ...
               cy = getHeight() / 2 + (MAX_OFFSET_Y - mUpDistance) - BALL_RADIUS;
                Log.i("111111","cy1:"+cy);
            } else {
                //自由落体

                cy = getHeight() / 2 - freeBallDistance - BALL_RADIUS;
                Log.i("111111","cy2:"+cy);
//                canvas.drawCircle(getWidth() / 2, , BALL_RADIUS, mPaint);
            }
//            Log.i("111111","cy:"+cy);
